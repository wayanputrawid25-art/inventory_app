...
-- View rolling stok outlet per periode audit.
-- Jika opening bulan berjalan belum diisi, sistem memakai closing bulan sebelumnya.
...
-- 4. Endpoint audit membaca rolling stock dari vw_outlet_stock_monthly.
-- 5. Analisis level siswa memakai produk_level_mapping + outlet_siswa_level_bulanan.
